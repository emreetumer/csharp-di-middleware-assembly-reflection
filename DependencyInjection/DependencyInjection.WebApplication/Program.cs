...
builder.Services.AddControllers(); // 1) Ben controller yapýsý kullanacaðým bunu ihtiyaç duyarsan bu yapýya göre instance üret demek(daha instance üretilmedi saece not olarak ekledi.)
...
//builder.Services.AddScoped<IApplicationBuilder, Builder>(); // Dependency Inversion kuralýdýr. Interface kullanýmýnýn adýdýr.
